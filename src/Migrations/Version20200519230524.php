 ...
 */
final class Version20200519230524 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE abonnement (id INT AUTO_INCREMENT NOT NULL, formule_id INT DEFAULT NULL, panier_id INT DEFAULT NULL, user_id INT DEFAULT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, state INT NOT NULL, is_paid INT NOT NULL, active INT NOT NULL, resilie INT NOT NULL, INDEX IDX_351268BB2A68F4D1 (formule_id), INDEX IDX_351268BBF77D927C (panier_id), INDEX IDX_351268BBA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE config (id INT AUTO_INCREMENT NOT NULL, mkey VARCHAR(255) NOT NULL, value VARCHAR(2000) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE temoignage (id INT AUTO_INCREMENT NOT NULL, creation DATE NOT NULL, name VARCHAR(255) NOT NULL, location VARCHAR(255) NOT NULL, video VARCHAR(255) DEFAULT NULL, text VARCHAR(1000) DEFAULT NULL, note DOUBLE PRECISION DEFAULT NULL, progress VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, stripe_custom_id VARCHAR(255) DEFAULT NULL, enabled TINYINT(1) NOT NULL, surname VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, town VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, street VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
